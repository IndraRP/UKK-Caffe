    ...
    <nav className="relative bg-white shadow dark:bg-gray-900 w-screen">
      <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
        <div className="flex items-center justify-between">
          <a href="/manajer">
            <h1 className='text-white font-extrabold font-mono text-lg'>WiCaffe_Manajer</h1>
          </a>
            ...
            <div className="relative ml-10">
              ...
              {dropdownOpen && (
                <ul className="absolute right-0 z-20 mt-2 w-48 bg-white border border-gray-200 rounded shadow-lg text-sm">
                  ...
                  <li
                    className="px-4 py-2 text-gray-700 cursor-pointer hover:bg-gray-100 text-sm font-bold"
